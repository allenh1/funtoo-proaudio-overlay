...
DESCRIPTION="ape experimental input plugin for the alsaplayer."
...
ESVN_REPO_URI="https://svn.sourceforge.net:/svnroot/alsaplayer/trunk/experimental/ape"
...
src_install() {
	mkdir -p "${D}/usr/lib/alsaplayer/input"
