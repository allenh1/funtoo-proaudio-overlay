...
inherit eutils kde-functions patcher
...
src_compile() {
	...
	local myconf="$(use_enable jack jack-support) \
			...
			--disable-PortAudio --disable-PortMidi"
	# debug needs to be enabled via this line
	# because the confiure script just looks it debug was passed at cmd
	# --> no longer needed as configure.in.patch above. [ 20070109] )
