...
# $Header: /cvsroot/jacklab/gentoo/media-sound/fmit/fmit-0.96.5.ebuild,v 1.1 2006/04/10 16:16:23 gimpel Exp $
...
src_compile() {
	econf `use_enable jack` `use_enable alsa` `use_enable debug` \
