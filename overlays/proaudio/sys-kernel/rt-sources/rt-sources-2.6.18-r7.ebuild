...
SRC_URI="${KERNEL_URI}
vesafb-tng? ( http://proaudio.tuxfamily.org/patches/vesafb-tng-1.0-rc2_2.6.18-rt.patch.bz2 ) 
$(get_valid_url "${FIRST_URL}" "${SEC_URL}")
fbsplash? ( http://proaudio.tuxfamily.org/patches/fbsplash-0.9.2-r5_2.6.18-rt7.patch.bz2 )"
...
src_unpack(){
	...
	use vesafb-tng && epatch "${DISTDIR}/vesafb-tng-1.0-rc2_2.6.18-rt.patch.bz2"
	use fbsplash && epatch "${DISTDIR}/fbsplash-0.9.2-r5_2.6.18-rt7.patch.bz2"
}
